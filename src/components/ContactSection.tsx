...
const ContactSection = () => {
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-purple-600 via-blue-500 to-pink-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Transform Your Web Presence?</h2>
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-6 md:p-10 bg-gradient-to-br from-purple-700 to-blue-600 text-white flex flex-col">
